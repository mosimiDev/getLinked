...
const Home = () => {
  return (
    <div id="home">
      <h1 className="text-3xl text-white font-bold tracking-wide py-3  sm:text-yellow md:text-white lg:text-yellow xl:text-white">
        Earn for who you are
      </h1>
      <p className="text-white py-3 w-2/3 mx-auto tracking-wider font-medium md:text-xl">
      ...
      <button className="bg-yellow my-5 w-5/6 md:w-32 rounded-xl px-5 md:font-bold py-3">
        Play Game
      </button>
      <img src={require("../assets/Mascot.png")} className="mx-auto" />
      <p className="text-white text-md tracking-wider font-medium md:text-xl">
        Supported by
      </p>
